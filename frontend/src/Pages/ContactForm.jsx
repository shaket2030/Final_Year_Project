...
export const ContactUs = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .send('service_issskqs', 'template_n713s3o', {
                user_email: 'haquetabassum786@gmail.com', // Admin email
                message: `Query from ${clientName}: ${form.current['message'].value}`,
            }, { publicKey: 'qzFpf7j9VTe60Hv0c' })
            .then(() => {
            ...
            <div className="container">
                <div className="row">
                    <div className="contact-left">
                        ...
                        <p><b className=''>Admin Mail</b> : <u >haquetabassum786@gmail.com</u></p>
                    </div>
